...
import com.example.inipunyahilmiy.Adapter.GalleryAdapter;
import com.example.inipunyahilmiy.Model.GalleryModel;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GalleryModel gallery7 = new GalleryModel(R.drawable.gallery7);
        galleryModel.add(gallery7);
        GalleryModel gallery8 = new GalleryModel(R.drawable.gallery8);
        galleryModel.add(gallery8);
        GalleryModel gallery9 = new GalleryModel(R.drawable.gallery9);
        galleryModel.add(gallery9);
        GalleryModel gallery10 = new GalleryModel(R.drawable.gallery10);
